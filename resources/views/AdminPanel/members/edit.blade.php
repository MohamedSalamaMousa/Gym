...
@include('AdminPanel.layouts.common.response-messages')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.member.update',$admin->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="divider">
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-12 col-sm-3 mb-1">
                                ...
                                <input type="phone" class="form-control" name="phone" id="phone" value="{{ $admin->phone }}" required />
                                @error('phone')
                                <p class="text-danger"> {{ $message }} </p>
                                @enderror
                            </div>
