...
@section('content')
                        ...
                        <table class="table">
                            ...
                            @foreach ($admins as $value )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($value->status == 1)
                                        <span class="badge bg-label-success me-1">{{ trans('common.active') }}</span>
                                        @else
                                        <span class="badge bg-label-warning me-1">{{ trans('common.inactive') }}</span>
                                        @endif
                                    ...
                                    <td class="text-center"> 
                                        @if ($value->getRoleNames()[0] == 'manger')
                                            ...
                                            <a href="{{ route('admin.member.edit',$value->id) }}" class="btn btn-icon btn-info"
                                        ...
                                        <?php $delete = route('admin.member.delete',$value->id); ?>
    ...
    <a href="{{ route('admin.member.create') }}" class="btn btn-primary"> {{ trans('common.CreateNew') }} </a>
    @endsection
