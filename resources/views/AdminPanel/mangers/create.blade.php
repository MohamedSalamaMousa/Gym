...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.manger.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="divider">
                        ...
                        <div class="row pt-3">
                            <div class="col-12 col-sm-3 mb-1">
                                ...
                                <input type="name" class="form-control" name="name" id="name"
                                    placeholder="{{ trans('common.name') }}" required/>
                                    @error('name')
                            ...
                            <div class="col-12 col-sm-3 mb-1">
                                ...
                                <input type="phone" class="form-control" name="phone" id="phone" value="{{ old('phone') }}" required/>
                                @error('phone')
                                <p class="text-danger"> {{ $message }} </p>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-sm-3 mb-1">
                                ...
                                <select class="form-select" id="role" aria-label="Default select example" name="role" id="role" required>
                                    <option disabled selected required>{{ trans('common.Roles') }}</option>
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-12 col-sm-3 mb-1">
                                ...
                                name="password_confirmation"
                                    placepassword_confirmationholder="password_confirmation"  required/>
