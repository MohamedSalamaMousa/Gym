...
return [
    ...
    */
    ...
    'font_data' => [
        'dejavu' => [
            'R' => 'DejaVuSans.ttf',     // الخط العادي
            'B' => 'DejaVuSans-Bold.ttf', // الخط العريض
            'I' => 'DejaVuSans-Italic.ttf', // الخط المائل
            'BI' => 'DejaVuSans-BoldItalic.ttf', // الخط العريض المائل
            'useOTL' => 0xFF,            // خيارات تفعيل دعم الكتابة
            'useKashida' => 75,          // دعم التشكيل العربي
        ],
    ],

    'default_font' => 'dejavu', // تحديد الخط الافتراضي
    'options' => [
        /**
